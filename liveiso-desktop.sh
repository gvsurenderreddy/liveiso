...
iso_name="gnuramalinux-desktop-$iso_version.iso"
...
pan -A infra x11 supra gnome root=work/rootfs
pan -a enlightenment terminology firefox mesa-demos syslinux mtools gptfdisk parted shim btrfs-progs root=work/rootfs
setup-chroot -u work/rootfs

chroot work/rootfs /bin/sh -c "echo 'root:root' | chpasswd"
chroot work/rootfs /bin/sh -c "useradd -m -G users,audio,video,wheel liveuser"
chroot work/rootfs /bin/sh -c "echo 'liveuser:liveuser' | chpasswd"
